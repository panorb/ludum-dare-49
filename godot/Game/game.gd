...
onready var control_panel = get_node("Playback")
...
func _ready():
	...
	control_panel.play_chapter("example-success")
...
func _on_chapter_ended(chapter_id):
	...
	if chapter_id == "example-success":
		...
		control_panel.load_character("american-spy")
